...
export const pricingProfiles: PricingProfile[] = [
  {
    ...
    items: [
      { productId: "prod_1", basePrice: 120, adjustedPrice: 108 },
      { productId: "prod_2", basePrice: 48, adjustedPrice: 43.20 },
      { productId: "prod_3", basePrice: 42, adjustedPrice: 37.80 },
      { productId: "prod_4", basePrice: 55, adjustedPrice: 49.50 },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod_1", basePrice: 120, adjustedPrice: 105 },
    ],
  ...
  },
  {
    ...
    productFilter: { productId: "prod_1" },
    items: [
