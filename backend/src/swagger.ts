...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "Pricing profiles, overlap resolution, products and customers",
    },
      ...
      schemas: {
        ...
        PricingProfile: {
          ...
          properties: {
            ...
            productScope: { type: "string", enum: ["explicit", "product", "subCategory", "segment", "all"] },
            productFilter: {
              type: "object",
              properties: {
                productId: { type: "string" },
            ...
            items: { type: "array", items: { $ref: "#/components/schemas/PricingProfileItem" } },
        ...
        ResolveResult: {
          ...
          properties: {
            ...
            sourceProfileId: { type: "string", nullable: true, example: "prof_scenario_c" },
            sourceProfileName: { type: "string", nullable: true, example: "Profile C" },
            explanation: { type: "string", example: "Matched Profile C with score 20 (individual + exact product)" },
          },
        },
        Error: {
          type: "object",
