...
export function ResolvePage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h1 className="text-lg font-semibold">Resolve Price</h1>
        ...
        <div className="rounded-lg border overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-muted/50">
              <tr>
                <th className="px-3 py-2 text-left font-medium text-xs text-muted-foreground">Product</th>
                <th className="px-3 py-2 text-right font-medium text-xs text-muted-foreground">Base Price</th>
                <th className="px-3 py-2 text-right font-medium text-xs text-muted-foreground">Adjustment</th>
                <th className="px-3 py-2 text-right font-medium text-xs text-muted-foreground">New Price</th>
                <th className="px-3 py-2 text-left font-medium text-xs text-muted-foreground">Profile Applied</th>
              </tr>
            </thead>
            <tbody className="divide-y">
              {results.map((item) => (
                <tr key={item.productId} className="hover:bg-muted/20">
                  ...
                  <td className="px-3 py-2 text-right tabular-nums">${item.basePrice.toFixed(2)}</td>
