...
# Trade-offs:
I used an in-memory store to keep the implementation focused on the customer specific pricing behaviour. On the frontend, I used usedQuery to improve data fetching and loading states and reduce unnecessary rerenders. I also focused on current pricing resolution first, while leaving historical price snapshotting, audit history, and advanced profile lifecycle rules as production improvements.
