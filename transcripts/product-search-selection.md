...
6 - plugins: [react()],  
 ...
 8 + resolve: {  
 9 + alias: {  
 10 + '@': path.resolve(\_\_dirname, './src'),  
 11 + },  
 12 + },  
 13 })
...
-de>HMR</code>  
 ...
 7 + <h1 className="text-xl font-semibold">Customer Pricing +</h1>  
 8 + </header>  
 9  
 33 - <div className="ticks"></div>  
 10 + <main className="flex gap-6 p-6">  
 11 + {/_ Left: filters + product table _/}  
...
3 +import { Sidebar, type View } from '@/components/Sidebar'  
 4  
 5 +const VIEW*LABELS: Record<View, string> = {  
 6 + products: 'Products',  
...
+w} />  
 18  
 10 - <main className="flex gap-6 p-6">  
 11 - {/* Left: filters + product table _/}  
 12 - <section className="flex-1 space-y-4">  
 ...
 20 + <h2 className="text-lg font-semibold mb-4">{VIEW_LABELS +[activeView]}</h2>  
